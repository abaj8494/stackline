...
-- Appearance
c.appearance.color                    = { white = 1 }    -- Indicator background color, e.g., {red = 0.5, blue = 0 }
...
c.appearance.size                     = 75                  -- Size of window indicators (height when icons off)
...
c.appearance.pillThinness             = 9                   -- Aspect ratio of pill-style icons (width = size / pillThinness)
...
c.appearance.offset.y                 = 3                   -- Distance from top of the window to render indicators
